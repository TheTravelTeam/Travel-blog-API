...
INSERT INTO article (title, content, cover_url, user_id, slug, created_at, updated_at) VALUES ('Itinéraire caféiné en Scandinavie', 'Un tour des coffee shops incontournables d''Oslo à Stockholm.', 'https://res.cloudinary.com/demo/image/upload/v1700000000/articles/scandinavie-coffee.jpg', 4, 'itineraire-cafeine-scandinavie', NOW(), NOW());
INSERT INTO article (title, content, cover_url, user_id, slug, created_at, updated_at) VALUES ('Randonner dans les Rocheuses', 'Mes conseils pour profiter des parcs nationaux canadiens.', 'https://res.cloudinary.com/demo/image/upload/v1700000000/articles/rocheuses-guide.jpg', 5, 'randonner-dans-les-rocheuses', NOW(), NOW());
INSERT INTO article (title, content, cover_url, user_id, slug, created_at, updated_at) VALUES ('Bivouac sous les étoiles du Sahara', 'Préparer sa nuit dans le désert : équipement et sécurité.', 'https://res.cloudinary.com/demo/image/upload/v1700000000/articles/sahara-bivouac.jpg', 6, 'bivouac-sous-les-etoiles-du-sahara', NOW(), NOW());
INSERT INTO article (title, content, cover_url, user_id, slug, created_at, updated_at) VALUES ('Guide des Cyclades en 7 jours', 'Que voir et que faire lors d''une semaine dans les Cyclades.', 'https://res.cloudinary.com/demo/image/upload/v1700000000/articles/cyclades-guide.jpg', 4, 'guide-cyclades-7-jours', NOW(), NOW());
